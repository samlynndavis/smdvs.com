...
const IndexPage = () => {
    ...
    return (
        <Layout>
            ...
            <h1 className={layoutStyles.hero}>I'm a Chicago-based freelance developer and <a href="https://www.samlynndavis.com" target="_blank" rel="noopener noreferrer" ><span className={layoutStyles.job__title}>visual artist</span></a> specializing in motion and interaction.</h1>
